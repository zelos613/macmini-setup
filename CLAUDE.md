...
| **モデルID** | Mac16,10 |
| **チップ** | Apple M4 (10コア：Performance 4 + Efficiency 6) |
| **メモリ** | 16 GB LPDDR5 (Hynix) |
| **ストレージ** | 256 GB SSD (APPLE SSD AP0256Z) / 空き容量 122.54 GB |
| **ファイルシステム** | APFS |
| **OS** | macOS 26.3 (25D125) |
| **ホスト名** | MameのMac mini（ユーザー: Mame） |
| **用途** | 自宅サーバー / AI処理 / Bot運用 |
| **稼働時間** | 16日 2時間 13分 |
| **セキュリティ** | SIP有効 / Secure Virtual Memory有効 / Activation Lock有効 |
